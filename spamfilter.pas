...
type
  ...
  public
    ...
    function DeleteWord(const aWord: String): Boolean;
...
function TSpamFilter.DeleteWord(const aWord: String): Boolean;
var
  aIndex: Integer;
begin
  Result:=FWords.Find(aWord, aIndex);
  if Result then
    FWords.Delete(aIndex);
end;
  ...
  begin
    ...
    try
      ...
      for s in aWords do
        ...
        begin
          Existing := FWords.Data[i];
          Inc(Existing.Spam, aCountRec.Spam);
          Inc(Existing.Ham, aCountRec.Ham);
        end
        else
